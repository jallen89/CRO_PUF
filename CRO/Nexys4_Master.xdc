...
set_property PACKAGE_PIN U8 [get_ports {control_bit[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {control_bit[0]}]
##Bank = 34, Pin name = IO_L23P_T3_34,						Sch name = SW2
set_property PACKAGE_PIN R7 [get_ports {control_bit[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {control_bit[1]}]
##Bank = 34, Pin name = IO_L19P_T3_34,						Sch name = SW3
set_property PACKAGE_PIN R6 [get_ports {control_bit[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {control_bit[2]}]
...
set_property PACKAGE_PIN T8 [get_ports output_bit]
...
resize_pblock [get_pblocks RO_PBLOCK] -add {SLICE_X78Y74:SLICE_X79Y74}

set_property BEL A5LUT [get_cells output_bit_OBUF_inst_i_1]
set_property LOC SLICE_X79Y74 [get_cells output_bit_OBUF_inst_i_1]
set_property BEL A6LUT [get_cells inverter_top_2/b_INST_0]
set_property LOC SLICE_X79Y74 [get_cells inverter_top_2/b_INST_0]
set_property BEL B6LUT [get_cells inverter_top_0_i_1]
set_property LOC SLICE_X79Y74 [get_cells inverter_top_0_i_1]
set_property BEL C6LUT [get_cells inverter_top_0/b_INST_0]
set_property LOC SLICE_X79Y74 [get_cells inverter_top_0/b_INST_0]
set_property BEL A6LUT [get_cells inverter_top_2_i_1]
set_property LOC SLICE_X78Y74 [get_cells inverter_top_2_i_1]
set_property BEL B5LUT [get_cells inverter_bot_2/b_INST_0]
set_property LOC SLICE_X79Y74 [get_cells inverter_bot_2/b_INST_0]
set_property BEL D6LUT [get_cells inverter_top_1_i_1]
set_property LOC SLICE_X79Y74 [get_cells inverter_top_1_i_1]
set_property BEL C5LUT [get_cells inverter_bot_0/b_INST_0]
set_property LOC SLICE_X79Y74 [get_cells inverter_bot_0/b_INST_0]
set_property BEL D5LUT [get_cells inverter_top_1/b_INST_0]
set_property LOC SLICE_X79Y74 [get_cells inverter_top_1/b_INST_0]
set_property BEL A5LUT [get_cells inverter_bot_1/b_INST_0]
set_property LOC SLICE_X78Y74 [get_cells inverter_bot_1/b_INST_0]
